		...
		>
			...
			<Box>
				<Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
					...
					<Button variant="contained" size="small" onClick={() => navigate(`/address`)}>
					<Translate text="ChangeAddress" />
					</Button>
				</Box>
				<Typography
					variant="body1"
			...
			<Box sx={{ mt: 2 }}>
				...
				<Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mt: 1 }}>
					...
					<Button variant="contained" size="small" onClick={() => navigate(`/BankAndCard`)}>
					<Translate text="More" />
					</Button>
				</Box>
			</Box>
